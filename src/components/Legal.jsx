    ...
    <div>
      <div className="legal">
        ...
        <p>
          ...
          du site{" "}
          <a href="https://www.claireturner-design.com">
            https://www.claireturner-design.com
          </a>{" "}
        ...
        <p>
          ...
          décidée par Claire Turner Design, qui s’efforcera alors de communiquer
        ...
        <p>
          SClaire Turner Design s’efforce de fournir sur le site{" "}
          <a href="https://www.claireturner-design.com">
            https://www.claireturner-design.com
          </a>{" "}
        ...
        <p>
          Claire Turner Design est propriétaire des droits de propriété
        ...
        <p>
          ...
          préalable de : Claire Turner Design.
        </p>
        <p>
        ...
        <p>
          Claire Turner Design ne pourra être tenue responsable des dommages
          directs et indirects causés au matériel de l’utilisateur, lors de
          l’accès au site https://www.claireturner-design.com, et résultant soit
        ...
        <p>
          Claire Turner Design ne pourra également être tenue responsable des
        ...
        <p>
          ...
          l’espace contact) sont à la disposition des utilisateurs. Claire
          Turner Design se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, Claire Turner
          Design se réserve également la possibilité de mettre en cause la
        ...
        <p>
          {" "}
          En tout état de cause Claire Turner Design ne collecte des
        ...
        <p>
          ...
          rachat de Claire Turner Design et de ses droits permettrait la
        ...
        <p>
          ...
          mis en place avec l’autorisation de Claire Turner Design. Cependant,
          Claire Turner Design n’a pas la possibilité de vérifier le contenu des
